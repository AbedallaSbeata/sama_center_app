                ...
                children: [
                  ...
                  Text(title,
                      style: const TextStyle(
                          fontSize: 15, fontFamily: 'Tajawal', fontWeight: FontWeight.bold, color: Colors.black)),
                  const SizedBox(height: 5),
                  Text(text,
                      style: const TextStyle(
                          fontSize: 14, fontFamily: 'Harmattan', fontWeight: FontWeight.bold, color: Colors.black),
